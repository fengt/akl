package cn.com.akl.ccgl.cgrk.job;
...
import cn.com.akl.ccgl.cgrk.biz.DealPriceForEmailNoticeBiz;
...
public class DealPriceForEmailNoticeJob implements IJob{
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		String sql = "select distinct wlbh,zcrq,HSJG from " + CgrkCnt.tableName0 + " a," + CgrkCnt.tableName1 + " b where a.bindid = b.bindid and wlbh is not null and zcrq is not null" ;
		try {
