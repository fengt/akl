...
import cn.com.akl.u8.cxml.CunsignmentUtil;
 ...
 *
 */
public class SendCunsignmentData {
	...
	public void sendData(Hashtable<String, String> head,Vector<Hashtable<String, String>> body) throws Exception{
		...
		String md = mapB.get("MD");
			try {
			 ...
			 CunsignmentUtil cu = new CunsignmentUtil();
			 Map<String, Object> map = cu.CunsignmentData(head, body);
			 //文件下载
			 String xml = cu.cunsignmentXML(map);
			 String yswj = FileDown.fileDown("发货单",ys,xml);
			...
			//U8返回消息
			 ...
			 String mdwj = FileDown.fileDown("发货单-return",md, responseXml);
			 System.out.println();
