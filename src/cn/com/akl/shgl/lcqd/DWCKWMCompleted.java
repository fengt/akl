 ...
 *
 */
public class DWCKWMCompleted extends WorkFlowEventClassA {

	public DWCKWMCompleted() {
		// TODO Auto-generated constructor stub
	}

	public DWCKWMCompleted(UserContext arg0) {
		super(arg0);
		setVersion("1.0.0");
		setProvider("鲁祥宇");
		setDescription("对外出库流程结束后,生成9#报文");
	}
	...
	private void creatXml9(int bindid, String url) {
		...
		try {
            ...
            //根据bindid查询送修单数据
			Vector<Hashtable<String,String>> vector=BOInstanceAPI.getInstance().getBODatas("BO_AKL_SH_DWCK_HZ_S", bindid);
