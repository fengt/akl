 ...
 *
 */
public class DWRKWMCompleted extends WorkFlowEventClassA {

	public DWRKWMCompleted() {
		// TODO Auto-generated constructor stub
	}

	public DWRKWMCompleted(UserContext arg0) {
		super(arg0);
		setProvider("鲁祥宇");
		setVersion("1.0.0");
		setDescription("对外入库流程结束后,生成9#报文");
	}
	...
	private void creatXml9(int bindid, String url) {
		...
		try {
            ...
            //根据bindid查询送修单数据
			Vector<Hashtable<String,String>> vector=BOInstanceAPI.getInstance().getBODatas("BO_AKL_SH_DWRK_S", bindid);
			...
			for(Hashtable<String,String> re:vector){
	        	...
	        	String dwrkdh=DBSql.getString("select DWRKDH from BO_AKL_SH_DWRK_P where bindid='"+bindid+"'", "DWRKDH");
	        	System.out.println("对外入库单号"+dwrkdh);
	        	inven.addElement("TRANSID").addText(dwrkdh);//对外入库单号
