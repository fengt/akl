...
public class UpdateHhztForHhdjStepNo3Event extends WorkFlowStepRTClassA{

	private Connection conn = null;

	public UpdateHhztForHhdjStepNo3Event(UserContext uc) {
		super(uc);
	
		setProvider("QJC");
		setDescription("V1.0");
		setDescription("财务审批办理后，更新还货单的状态为：更新还货单单身“已审批”");
	}
	@Override
		...
		if(tyFlag == true){
			...
			try {
				...
				if(rs!=null){
					...
					String sql1 = "update "+HHDJConstant.tableName0+"  set ZT =2 where bindid = '" + bindid + "'";//更新还货单状态
